			...
			<div class="topbar <?php echo esc_attr($kyma_theme_options['topbarcolor']); ?>">
				...
				<div class="content clearfix">
					...
					<div class="top_details clearfix f_left"><?php
						...
						?>
					<span><i class="fa fa-phone"></i><span class="title"><?php _e('Call Us :', 'kyma') ?></span><a href="tel:<?php echo esc_attr($kyma_theme_options['contact_phone']); ?>"><?php echo esc_attr($kyma_theme_options['contact_phone']); ?></a>
							</span><?php
						}
								...
								if ($kyma_theme_options['social_facebook_link'] != '') {
									...
									if ($kyma_theme_options['social_google_plus_link'] != '') {
										...
										<div id="navigation_bar" style="<?php if (get_header_image()) : ?> background-image:url('<?php header_image();?>'); <?php endif; ?>">
											<div class="cont-95">
												<div id="logo" class="col-xs-9 col-sm-4" <?php if ($kyma_theme_options['logo_layout'] == "right") {
