...
$outgoingServerAddress      = 'box750.bluehost.com'; // Consult your hosting provider.
...
$sendingAccountUsername     = 'info@unbrandedcreative.com';
$sendingAccountPassword     = 'zf5Q[fs.EM6tPq';

// Recipient (To:) Details  - Change this to the email details of who will receive all the emails from the website.
$recipientEmail             = 'info@unbrandedcreative.com'; // REQUIRED value.
$recipientName              = 'Unbranded Creative';             // REQUIRED value.

// Email details            - Change these to suit your website needs
$emailSubject               = 'A message from Unbranded Creative'; // REQUIRED value. Subject of the email that the recipient will see
$websiteName                = 'Unbranded Creative';                // REQUIRED value. This is used when a name or email is not collected from the website form
